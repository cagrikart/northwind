...
public interface ProductService {
    ...
    DataResults<Product> getByProductNameAndAndCategoryId(String productName, int categoryId); //  hem product name i hem de category ıd i getir

    DataResults<List<Product>> getByProductNameOrCategoryId(String productName, int categoryId); // product name i ya da category name i getir
